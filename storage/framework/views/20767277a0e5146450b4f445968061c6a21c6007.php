<?php $__env->startSection('seoSchemaContent'); ?>
    <script type='application/ld+json'><?php echo $CatalogueBreadcrumb; ?></script>
                            ...
                            <div class="col-12 bg-white">
                                ...
                                <div class="row">
                                    <div class="col-12 text-gray product-details">
                                        ...
                                        <input type="hidden" value="<?php echo e($cat_slug); ?>" id="cat_slug">
                                        ...
                                        <div class="row justify-content-center p-3">
                                            <div class="col-auto">
                                                <button onclick="load_more_cat_product_list();" class="btn btn-themacolor-border pl-5 pr-5 text-uppercase">View
                                                    all
                                                </button>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    function load_more_cat_product_list(){
        ...
        $.ajax({
            url: '<?php echo route('web_biz_catalogue_product_list_load_more'); ?>',
            type: 'POST',
            data: {
                'start': product_count,
                'cat_slug': cat_slug,
